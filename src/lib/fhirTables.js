 ...
 * @param {string?} language The desired user language, null if the bundle language matches the user language
 */
function allergyRow(r, rmap, dcr, language = null) {
 ...
 * @param {string?} language The desired user language, null if the bundle language matches the user language
 */
function immunizationRow(r, rmap, dcr, language = null) {
...
function obsRow(r, rmap, dcr, language = null) {
  ...
  const outerName = (r.code ? futil.renderCodeableJSX(r.code, dcr, language) : "");
  ...
  if (r.component && r.component.length) {
	for (const i in r.component) {
	  ...
	  const compName = (c.code ? futil.renderCodeableJSX(c.code, dcr, language) : "");
